...
class MyLinkedList
{
  ...
  public:
    ...
    //find the data elements from iterator "from" (inclusive) to iterator "to" (exclusive)
    //return the iterator "to"
    iterator find(iterator from, iterator to, DataType& x)
    {
